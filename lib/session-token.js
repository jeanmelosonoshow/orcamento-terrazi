...
export function createSessionToken(user = {}) {
    ...
    const filiaisPermitidas = Array.from(new Set((Array.isArray(user.filiaisPermitidas) ? user.filiaisPermitidas : [])
    ...
    const payload = encode(JSON.stringify({
        ...
        filiaisPermitidas,
        architectBudgetEditor: user.architectBudgetEditor === true,
        iat: now,
