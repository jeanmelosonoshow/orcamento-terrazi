...
test('KPI usa a confirmacao do servidor para nao agregar novamente no navegador', async () => {
    const fonte = await readFile(crmJsUrl, 'utf8');
    ...
    assert.ok(fonte.includes('dadosConsultaAgregados: data.resultadoAgregado === true'));
});
